...
bool GlobalSettings::HasChanged() const { return changed; }

const char *GlobalSettings::GetPatch() const { return patch.String(); }
...
const char *GlobalSettings::GetKeyMap() const { return keyMap.String(); }
...
double GlobalSettings::GetMainVolume(void) const { return mainVolume; }
...
int32 GlobalSettings::GetSamplingRate(void) const { return samplingRate; }
...
reverb_mode GlobalSettings::GetReverb() const { return reverb; }
...
int16 GlobalSettings::GetMaxSynthVoices() const { return maxSynthVoices; }
...
int16 GlobalSettings::GetLimiterThreshhold() const { return limiterThreshhold; }
#endif
...
int16 GlobalSettings::GetKeyboardOctaves() const { return keyboardOctaves; }
...
int16 GlobalSettings::GetKeyboardRows() const { return keyboardRows; }
...
BPoint GlobalSettings::GetWindowPosition() const { return windowPos; }
...
BPoint GlobalSettings::GetScopeWindowPosition() const { return scopeWindowPos; }
